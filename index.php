<?php
  ...
  $db = sparql_connect("http://localhost:3030/labpw/sparql");
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top ">
            <div class="container-fluid">
                <h2 class="amiri ms-5 my-2 fs-2">List Indonesian Singers</h2>
        ...
        <?php
            ...
            WHERE
            {
                ?singer foaf:image ?wiki;
                        dbp:name ?Name;
                        dbo:birthDate ?BirthDate;
                        dbo:birthPlace ?BirthPlace;
                        dbo:activeYearsStartYear ?ActiveYearsStart;
            ...
            <table class="table table-light table-bordered m-0 p-0">
                ...
                ?>
                    ...
                    <?php foreach($fields as $field){ 
                        ...
                        if($j==1) continue;
                        if($j==2){
                            echo "<td><img src='".$img_file->image."' class=' mx-auto cover-img'></img></td>";
                            continue;
                        }
